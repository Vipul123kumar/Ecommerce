...
const Signup = () => {
  return (
    <div>
     ...
     <div className='bg-white flex flex-col items-center justify-center m-auto w-119 h-130 border-1 '>
       <div className='flex flex-col mb-35 p-2 '> 
        <h1 className='text-2xl mr-70 p-5 mt-20    '>Signup </h1>
        <div className='flex flex-col gap-5 mb-5 p-5 items-center justify-center  '>
        <input type='name'placeholder='Your name ' className='border-1 h-10 w-90 text-center p-2 '/>
        <input type='email' placeholder='Email Address' className='border-1 h-10 w-90 text-center '/>
        ...
        <p className='m-2 p-2 '>Already have an account? <Link to="/login"> <span className='  text-red-300 cursor-pointer hover:text-red-400'>Login here</span> </Link> </p>
